...
/**
 * Modelo que representa un pedido en la aplicación.
 */
public class Pedido {
    private int id;
    private int id_sala;
    ...
    public Pedido(int id, int id_sala, int num_mesa, String fecha, double total, String sala, String usuario, String estado, double pago_efectivo, double pago_transaccion) {
        this.id = id;
        this.id_sala = id_sala;
        this.num_mesa = num_mesa;
        this.fecha = fecha;
